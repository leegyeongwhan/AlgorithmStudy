...
public class _17478 {
    ...
    static String underBar = ""; //여기서 클래스 변수로 초기화 해주고시작한다

    static void recycle(int num) { //2
        //   System.out.println("underBar = " + underBar);
        String bar = underBar;       //클래스변수를 지역변수에 넣어줘서 그때 그때 마다 값이 다르게해줌
        if (num == 0) {
